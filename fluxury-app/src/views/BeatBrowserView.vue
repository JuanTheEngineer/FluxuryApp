<template>
  <div class="p-4 space-y-4 bg-cyan-900">
    <h1 class="text-2xl font-bold mb-2 text-slate-300">Fluxury Beats</h1>
...
import { downloadBeat, getBeats } from '../services/api'
